...
function get_social_share_link( $network = '', $data = array() ) {
	...
	switch ( $network ) {
		...
		case "email":
			return sprintf(
				'<a href="mailto:?subject=%1$s&body=%2$s" title="%3$s"><span%4$s>%3$s</span></a>',
		...
		case "google":
			return sprintf(
				'<a class="share-popup" href="https://plus.google.com/share?url=%1$s" data-width="624" data-height="486" title="%2$s"><svg class="social-svg"><use xlink:href="#icon-googleplus-round" /></svg></a>',
				urlencode( esc_url_raw( $data[ 'link' ] ) ),
				__( 'Share on Google+' ),
				$class
			);
		...
		case "pinterest";
			if ( empty( $data[ 'image_src' ] ) ) {
				...
				$link = sprintf(
					'<a class="share-popup" href="http://pinterest.com/pin/create/button/?url=%1$s&amp;media=%2$s&amp;description=%3$s" data-width="624" data-height="300" title="%4$s"><span%5$s>%4$s</span><svg class="social-svg"><use xlink:href="#icon-pinterest-round" /></svg></a>',
					urlencode( esc_url_raw( $data[ 'link' ] ) ),
		...
		case "twitter":
			...
			return sprintf(
				'<a class="share-popup" href="https://twitter.com/share?url=%1$s&text=%2$s" data-width="550" data-height="450" title="%3$s"><span%4$s>%3$s</span><svg class="social-svg"><use xlink:href="#icon-twitter-round" /></svg></a>',
		...
		case "facebook":
			return sprintf(
				'<a class="share-popup" href="http://www.facebook.com/sharer.php?u=%1$s&t=%2$s" data-width="640" data-height="352" title="%3$s"><span%4$s>%3$s</span><svg class="social-svg"><use xlink:href="#icon-facebook-round" /></svg></a>',
				urlencode( esc_url( $data[ 'link' ] ) ),
				urlencode( $data[ 'title' ] ),
		...
		case "linkedin":
			return sprintf(
				'<a class="share-popup" href="http://www.linkedin.com/shareArticle?mini=true&url=%1$s&title=%2$s" data-width="640" data-height="352" title="%3$s"><span%4$s>%3$s</span><svg class="social-svg"><use xlink:href="#icon-linkedin-round" /></svg></a>',
				urlencode( esc_url( $data[ 'link' ] ) ),
				urlencode( $data[ 'title' ] ),

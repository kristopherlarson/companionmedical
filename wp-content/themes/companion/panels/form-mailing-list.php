...
if ( $_SERVER["REQUEST_METHOD"] == "POST" ) {
	...
	$subject = WEBSITE_NAME . ' Website Newsletter Sign-up';

	$email_top  = WEBSITE_NAME . ' Website Newsletter:';
	...
	if ( empty( array_filter( $errors ) ) ) {
		if ( wp_mail($email_recipients, $subject, $message, $headers) ) {
			...
			echo '<p class="callout">Thanks! We\'ll keep you up to date.</p>';
			$_POST = array();
...
<form id="standard-form" method="post" action="#contact-us">
	...
	<div class="mailing-list">
		...
		<input class="contact-full-name" name="last_name" type="text" pattern="[a-zA-Z ]+" placeholder="Last Name" value="<?php
